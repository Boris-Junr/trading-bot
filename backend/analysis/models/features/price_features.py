...
from analysis.indicators.trend import EMA
from analysis.indicators.momentum import RSI, Stochastic
from analysis.indicators.volatility import BollingerBands, ATR
